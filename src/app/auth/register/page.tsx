              ...
              <div className="mt-2">
                <div className="flex items-center mb-1">
                  <div className="w-full bg-gray-200 rounded-full h-2 mr-2">
                    <div className={`h-2 rounded-full ${passwordFeedback[passwordStrength - 1]?.color || ''}`} style={{ width: `${passwordStrength * 25}%` }}></div>
                  </div>
                  <span className="text-xs text-gray-600">{passwordStrength > 0 ? passwordFeedback[passwordStrength - 1]?.text : 'Too Short'}</span>
                </div>
